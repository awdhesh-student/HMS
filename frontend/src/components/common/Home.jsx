    ...
    <>
      ...
      <div className='home-container'>
        ...
        <div className="right-side">
          <p>
            <span className='f-letter'>Empower your healthcare institution with our advanced Hospital Management System –</span><br />
            <span className='t-letter'>simplifying operations, enhancing patient care.</span><br />
            <Button color='info' className='mt-3 register'><Link to={'/Login'}>Get Started</Link></Button>
          </p>
        </div>
      </div>
